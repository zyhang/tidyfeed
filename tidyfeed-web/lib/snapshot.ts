 ...
 * Twitter/X appends these short links at the end of tweets
 */
function stripTrailingTcoUrls(text: string): string {
	// Remove trailing t.co URLs (they appear at the end of tweets)
	// Pattern: one or more trailing https://t.co/... URLs optionally separated by spaces
